...
%ClangPath% -g -O3 language/Lexer/*.cpp language/Parser/*.cpp language/CodeGen/*.cpp language/AST/*.cpp *.cpp %LLVMConfigResult% -fstack-protector -lssp -frtti -std=c++20 -static -o tinyvale
